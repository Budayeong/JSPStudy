...
<script type="text/javascript">
    function validateForm(form) {  // 필수 항목 입력 확인
        ...
        /* 
        기존 패스워드 검증에 대한 if문은 삭제.
        수정페이지 진입 시 패스워드를 검증했기 때문에
        패스워드를 별도로 입력하지않기 때문.
        패스워드 검증을 위한 컨트롤러에서 session영역에 임시로 패스워드를 저장해놓은
        상태로 수정페이지로 이동하게됨.
        */
    }
</script>
...
<!-- 
수정에서도 파일을 첨부할 수 있으므로 enctype 속성 필요
그외 모든 속성은 쓰기와 동일
 -->
...
<table border="1" width="90%">
    ...
    <tr>
        <td>첨부 파일</td>
        <td>
        	<!-- 파일의 경우 value 속성을 사용하지 않는다. 만약 사용한다해도
        	단순한 String 정보이므로 의미가 없음 -->
