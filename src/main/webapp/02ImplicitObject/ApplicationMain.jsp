...
<body>
	...
	.metadata 디렉터리 하위에 프로젝트와 동일한 Tomcat 환경을
	만들어서 복사본 파일을 실행하게된다. 따라서 위에서의 물리적경로는
	.metadata 하위의 경로가 출력된다.
	 -->
	
	<!-- 
	사용하는 OS에 따라 경로를 표시하는 방법이 다르므로, application 내장객체를 통해
	절대경로를 얻어올 수 있다.
	 -->
	...
	*/
	public String useImplicitObject(){
		/* 
		방법1 : getServletContext() 메서드를 통해 선언부에서 application 내장 객체를 얻어올 수 있다.
		*/
		return this.getServletContext().getRealPath("/02ImplicitObject");
	}
	public String useImplicitObject(ServletContext app){
		/* 
		방법2 : 스크립트릿에서 메서드를 호출할때 application 내장객체를 매개변수로 전달해 사용
		*/
