...
String visitCookieOk = CookieManager.readCookie(request, "visit"+num);

if(visitCookieOk.equals("")){
	// 게시물 조회수 증가
	dao.updateVisitCount(num);
	// 	쿠키 생성
	CookieManager.makeCookie(response, "visit"+num, "visit"+num , 86400);
}
...
<!-- 
게시물을 삭제할때 JS를 통해 submit(전송)하기 위해 <form>태그를 기술한다. 
이 게시물의 일련번호를 hidden 입력상자에 설정한다.
-->
<form name="writeFrm">
<input type="hid-den" name="num" value="<%= num %>" />  
    ...
    <table border="1" width="90%">
        ...
        <tr>
            ...
            <!-- 입력시 줄바꿈을 위한 엔터는 \r\n으로 입력되므로 웹 브라우저에 출력시에는 <br> 태그로 변경해야한다  -->
        ...
        <tr>
            ...
            즉, 작성자 본인이 해당 게시물을 조회했을때만 버튼이 보이게 된다.
